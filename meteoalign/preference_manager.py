...
DEFAULT_PREFERENCE_VALUES: dict[str, object] = {
    ...
    "constellation_name_font_size_pt": 12,
    ...
    "auto_match_default_search_radius_px": 10,
    "sequence_psf_search_radius_px": 10,
...
PREFERENCE_COMMENTS: dict[str, str] = {
    ...
    "auto_match_default_search_radius_px": "星点匹配页自动扩展匹配的默认搜索半径，单位为像素。",
    "sequence_psf_search_radius_px": "图像序列解析使用的独立 PSF 搜索半径，单位为像素。",
