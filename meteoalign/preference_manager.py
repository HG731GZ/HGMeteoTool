...
PREFERENCE_COMMENTS: dict[str, str] = {
    ...
    "auto_pair_search_rms_multiplier": "右键自动配对搜索半径中配准 RMS 的倍率。",
    "auto_pair_search_base_radius_px": "右键自动配对搜索半径的基础增量，单位为像素。",
    "auto_pair_search_max_radius_px": "右键自动配对搜索半径的绝对上限，单位为像素。",
    "double_click_focus_auto_pair_enabled": "双击聚焦未配对参考星时是否联动执行静默自动配对。",
